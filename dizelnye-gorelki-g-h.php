<?php
	...
	$title = "$producteSectionTitle_2_6";
	$description = "$producteSectiomDescription_2_6"; 
	require 'header.php';
	require 'variable/data-info-finish-2.php';
	require 'variable/data-description.php';

	$data = require('variable/data-info-finish-2.php');
    $burnersModal = $data['dizelnye-gorelki-g-h'];
    $burnersModal2 = $data['dizelnye-gorelki-g-h-2'];
    
    $nameBurnsPage = "F.B.R. G H";
?>
	 	...
	 	<div class="container">
	 		<div class="bread-crumbs-content">
	 		 ...
	 		 <section class="section section-one section-one-text-center">
	 		 	<div class="container">
	 		 		<h1>Купить горелки для котлов на жидком топливе <?= $nameBurnsPage ?> (Ф.Б.Р.)</h1>
	 		 		<div class="text-title-category">
	 		 			<div class="left">
	 		 				<p>F.B.R. G H – дизельная горелка для установки на котлы и теплогенераторы. Модель работает при диапазоне от 39, 1 до 355 кВт.  Горелка полностью соответствует европейским стандартам качества. </p>
						</div>
			 		 	<div class="right">
