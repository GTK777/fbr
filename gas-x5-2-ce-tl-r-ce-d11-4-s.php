<?php
    ...
    $title = "$producteTitle_6_20";
    $description = "$producteDesc_6_20"; 
    ...
    $modificationModal = $modification["gazovye-gorelki-gas-x-2"][19];
    
    $modalPumpDesc = $modalPumpDesc_6_20;
    $modalPumpTable = $modalPumpTable_6_20;
?>
<!-- main block start -->
    <main class="main">
