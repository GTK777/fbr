<?php
	...
	$title = "$producteTitle_5_9";
	$description = "$producteDesc_5_9"; 
	...
	$dataLinkAll = $dataLink['pumpModal_seco_data'];
	
	$modalPump = $data['pumpModal_seco'][0];

	$modification = require('variable/data-info-finish-2.php');
	$dataDesc = require('variable/data-description.php');
	$modificationModal = $modification['pumpModal-mod_1_2'];
?>
	<main class="main">
			...
			<div class="container">
				<div class="bread-crumbs-content">
					<ul class="bread-crumbs-list">
						...
						<li class="bread-crumbs-item">
							<a href="suhie-plastinchato-rotornye-vakuumnye-nasosy-i-kompressory" class="bread-crumbs-link bread-crumbs-link-next bread-crumbs-link-spare-parts">Сухие пластинчато-роторные вакуумные насосы и компрессоры</a>
						</li>
						<li class="bread-crumbs-item">
							<a href="" class="bread-crumbs-link bread-crumbs-link-now">
							Busch <?= $modalPump['pumpModalName_9'] ?></a>
						</li>
					</ul> 
				</div>
			</div>
			...
			<div class="container">
				<div class="burners-modal-info__content">
					<div class="burners-modal-info__content-left">
						<img src="img/images/<?= $pump_9_name_5 ?>.png" alt="Оборудование Busch">
					</div>
					<div class="burners-modal-info__content-right">
						<h1 class="burners-modal-info__content-right_title">Вакуумный насос Busch <?= $modalPump['pumpModalName_9'] ?></h1>
						<?= $modalPump_5_Desc_9 ?>
						<span class="burners-modal-info__content-right_description under-title under-title-r"><?= $modalPump_5_UnderDesc_9 ?></span>
						...
						<div class="content-main-line">
							<div class="main-block-link main-block-link-first"> 
								<span class="main-line-block main-line-block-first">
									<span class="main-block-link-title"><a href="http://nasosy-vakuumnye.ru/suhie-plastinchato-rotornye-vakuumnye-nasosy-i-kompressory">Сухие пластинчато-роторные вакуумные насосы и компрессоры:</a></span>
				...
				<div class="photo-block">
					<div class="picture-performance-block picture-block">
						<img src="img/picture/<?= $pump_9_name_5 ?>.jpg" alt="Оборудование Busch">
						<p><?= $modalPump['pumpModalName_9'] ?></p>
					</div>
					<div class="picture-performance-block performance-block">
						<img src="img/performance/<?= $pump_9_name_5 ?>.jpg" alt="Оборудование Busch">
						<p>Производительность: Воздух при 20 °C. Погрешность ± 9% 50 Hz 60 Hz</p>
					</div>
				</div>
...
<h5 class="burners-modal-info__content-right_description title-desc">Технические характеристики:</h5><?= $modalPump_5_Table_9 ?>
				</div>
			</div>
		</section> 
	</main>
