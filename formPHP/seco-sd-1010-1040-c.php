<?php
	...
	$title = "$producteTitle_5_5";
	$description = "$producteDesc_5_5"; 
				...
				<div class="bread-crumbs-content">
					<ul class="bread-crumbs-list">
						...
						<li class="bread-crumbs-item">
							...
							Busch <?= $modalPump['pumpModalName_5'] ?></a>
						</li>
					</ul> 
				</div>
			</div>
			...
			<div class="container">
				<div class="burners-modal-info__content">
					<div class="burners-modal-info__content-left">
						<img src="img/images/<?= $pump_5_name_5 ?>.png" alt="Оборудование Busch">
					</div>
					<div class="burners-modal-info__content-right">
						<h1 class="burners-modal-info__content-right_title">Вакуумный насос Busch <?= $modalPump['pumpModalName_5'] ?></h1>
						<?= $modalPump_5_Desc_5 ?>
						<span class="burners-modal-info__content-right_description under-title under-title-r"><?= $modalPump_5_UnderDesc_5 ?></span>
				...
				<div class="photo-block">
					<div class="picture-performance-block picture-block">
						<img src="img/picture/<?= $pump_5_name_5 ?>.png" alt="Оборудование Busch">
						<p><?= $modalPump['pumpModalName_5'] ?></p>
					</div>
					<div class="picture-performance-block performance-block">
						<img src="img/performance/<?= $pump_5_name_5 ?>.png" alt="Оборудование Busch">
...
<h5 class="burners-modal-info__content-right_description title-desc">Технические характеристики:</h5><?= $modalPump_5_Table_5 ?>
				</div>
			</div>
		</section> 
	</main>
