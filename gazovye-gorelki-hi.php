	 	...
	 	<div class="container">
	 		<div class="bread-crumbs-content">
	 			<ul class="bread-crumbs-list">
					...
					<li class="bread-crumbs-item"><a href="boilers" class="bread-crumbs-link bread-crumbs-link-now">F.B.R. HI</a></li>
	 			</ul>
	 		</div>
	 	</div>
	 </section> 
	 		 ...
	 		 <section class="section section-one section-one-text-center">
	 		 	<div class="container">
	 		 		<h1>Купить газовые горелки F.B.R. HI (Ф.Б.Р.)</h1>
	 		 		<div class="text-title-category">
	 		 			<div class="left">
	 		 				<p>Газовое горелки GAS HI предназначены для работы с промышленными котлами для использования в сушильных барабанах, теплогенераторах и печах. Горелка работает при диапазоне от 1044 – 7558 кВт.  </p>
							<p>Конструкция горелки позволит быстро получить доступ к основным узлам и механизмам при проведении сервисных работ.</p>
						</div>
			 		 	<div class="right">
						 	<p>Горелка может быть представлена как с длинной, так и с короткой трубой.</p>
	 		 		...
	 		 		<div class="section-one-content">
						<? foreach ($burnersModal as $key) { ?>
							<a href="<?= $key['burnersModalLink'] ?>" class="catalog-item">
								<span class="catalog-item-top"><img src="img/images/gazovye-gorelki-hi.jpg" alt="Газовые горелки F.B.R. GAS X"></span>
