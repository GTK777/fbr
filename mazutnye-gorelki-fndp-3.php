<?php
    ...
    $title = "$producteSectionTitle_3_5";
    $description = "$producteSectiomDescription_3_5"; 
    require "header.php";
    require "variable/data-info-finish-3.php";
    require "variable/data-description.php";

    $data = require("variable/data-info-finish-3.php");
    $burnersModal = $data["mazutnye-gorelki-fndp-3"];
    
    $nameBurnsPage = "F.B.R. FNDP /3";
?>
              ...
              <section class="section section-one section-one-text-center">
                  <div class="container">
                      ...
                      <div class="text-title-category">
                          <div class="left">
                              <p>F.B.R  FNDP /2 – это мазутные трехступенчатые наддувные горелки. Горелка предназначена для работы с густым мазутом. Низкий шум вентилятора обеспечивается за счет специального вентилятора и защитного кожуха. </p>
                        </div>
                          <div class="right">
                              <p>Устройство работает при диапазоне 911 до 3980 кВт. Горелка может быть установлена практически на любой вид котлов, водонагревателей и парогенераторов.</p>
