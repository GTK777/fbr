<?php
    ...
    $title = "$producteTitle_6_18";
    $description = "$producteDesc_6_18"; 
    ...
    $modificationModal = $modification["gazovye-gorelki-gas-x-2"][17];
    
    $modalPumpDesc = $modalPumpDesc_6_18;
    $modalPumpTable = $modalPumpTable_6_18;
?>
<!-- main block start -->
    <main class="main">
            ...
            <div class="container">
                <div class="bread-crumbs-content">
                    <ul class="bread-crumbs-list">
                        ...
                        <li class="bread-crumbs-item">
                            <a href="gazovye-gorelki-gas-x-2" class="bread-crumbs-link bread-crumbs-link-next bread-crumbs-link-spare-parts">F.B.R. GAS X /2</a>
                        </li>
                        <li class="bread-crumbs-item">
