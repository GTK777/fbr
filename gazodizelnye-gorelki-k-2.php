	 	...
	 	<div class="container">
	 		<div class="bread-crumbs-content">
	 			<ul class="bread-crumbs-list">
					...
					<li class="bread-crumbs-item"><a href="#" class="bread-crumbs-link bread-crumbs-link-now">F.B.R. K /2</a></li>
	 			</ul>
	 		</div>
	 	</div>
	 </section> 
	 		 ...
	 		 <section class="section section-one section-one-text-center">
	 		 	<div class="container">
	 		 		<h1>Купить газодизельные горелки F.B.R. K /2 (Ф.Б.Р.)</h1>
	 		 		<div class="text-title-category">
	 		 			<div class="left">
	 		 				<p>F.B.R  K /2 -  это многофункциональная комбинированная горелка, работающая на природном газе и дизельном топливе. В зависимости от модели, устройство работает при диапазоне от 116 до 1506 кВт. Горелка характеризуется высоким КПД при минимальном выбросе вредных веществ. </p>
						</div>
			 		 	<div class="right">
