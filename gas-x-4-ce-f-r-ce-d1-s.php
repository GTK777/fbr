<?php
    ...
    $modificationModal = $modification["gazovye-gorelki-gas-x-f"][5];
    
    $modalPumpDesc = $modalPumpDesc_2_6;
    $modalPumpTable = $modalPumpTable_2_6;
?>
<!-- main block start -->
    <main class="main">
            ...
            <div class="container">
                <div class="bread-crumbs-content">
                    <ul class="bread-crumbs-list">
                        ...
                        <li class="bread-crumbs-item">
                            <a href="gazovye-gorelki-gas-x-f" class="bread-crumbs-link bread-crumbs-link-next bread-crumbs-link-spare-parts">F.B.R. GAS X F</a>
                        </li>
                        <li class="bread-crumbs-item">
