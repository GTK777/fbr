...
<?php
	...
	$title = "$producteTitle_3_17";
	$description = "$producteDesc_3_17"; 
			...
			<div class="container">
				<div class="burners-modal-info__content">
					<div class="burners-modal-info__content-left">
						<img src="img/images/<?= $pump_17_name_3 ?>.png" alt="Оборудование Busch">
					</div>
					<div class="burners-modal-info__content-right">
						...
						<?= $modalPump_3_Desc_17 ?>
						<span class="burners-modal-info__content-right_description under-title under-title-r"><?= $modalPump_3_UnderDesc_17 ?></span>
				...
				<div class="photo-block">
					<div class="picture-performance-block picture-block">
						<img src="img/picture/<?= $pump_17_name_3 ?>.jpg" alt="Оборудование Busch">
						<p><?= $modalPump['pumpModalName_17'] ?></p>
					</div>
					<div class="picture-performance-block performance-block">
						<img src="img/performance/<?= $pump_17_name_3 ?>.jpg" alt="Оборудование Busch">
...
<h5 class="burners-modal-info__content-right_description title-desc">Технические характеристики:</h5><?= $modalPump_3_Table_17 ?>
				</div>
			</div>
		</section> 
	</main>
