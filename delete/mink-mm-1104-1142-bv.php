<?php
	...
	$title = "$producteTitle_2_1";
	$description = "$producteDesc_2_1"; 
			...
			<div class="container">
				<div class="burners-modal-info__content">
					<div class="burners-modal-info__content-left">
						<img src="img/images/<?= $pump_1_name_2 ?>.png" alt="Оборудование Busch">
					</div>
					<div class="burners-modal-info__content-right">
						...
						<span class="burners-modal-info__content-right_description under-title under-title-r"><?= $modalPump_2_UnderDesc_1 ?></span>
						<?= $modalPump_2_Desc_1 ?>
				...
				<div class="photo-block">
					<div class="picture-performance-block picture-block">
						<img src="img/picture/<?= $pump_1_name_2 ?>.jpg" alt="Оборудование Busch">
						<p><?= $modalPump['pumpModalName_1'] ?></p>
					</div>
					<div class="picture-performance-block performance-block">
						<img src="img/performance/<?= $pump_1_name_2 ?>.jpg" alt="Оборудование Busch">
...
<h5 class="burners-modal-info__content-right_description title-desc">Технические характеристики:</h5><?= $modalPump_2_Table_1 ?>
				</div>
			</div>
		</section> 
	</main>
