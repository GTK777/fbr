<?php
	...
	$title = "$producteTitle_7_20";
	$description = "$producteDesc_7_20"; 
				...
				<div class="bread-crumbs-content">
					<ul class="bread-crumbs-list">
						...
						<li class="bread-crumbs-item">
							...
							Busch <?= $modalPump['pumpModalName_20'] ?></a>
						</li>
					</ul> 
				</div>
			</div>
			...
			<div class="container">
				<div class="burners-modal-info__content">
					<div class="burners-modal-info__content-left">
						<img src="img/images/<?= $pump_20_name_7 ?>.png" alt="Оборудование Busch">
					</div>
					<div class="burners-modal-info__content-right">
						<h1 class="burners-modal-info__content-right_title">Вакуумный насос Busch <?= $modalPump['pumpModalName_20'] ?></h1>
						<?= $modalPump_7_Desc_20 ?>
						<span class="burners-modal-info__content-right_description under-title under-title-r"><?= $modalPump_7_UnderDesc_20 ?></span>
				...
				<div class="photo-block">
					<div class="picture-performance-block picture-block">
						<img src="img/picture/<?= $pump_20_name_7 ?>.png" alt="Оборудование Busch">
						<p><?= $modalPump['pumpModalName_20'] ?></p>
					</div>
					<div class="picture-performance-block performance-block">
						<img src="img/performance/<?= $pump_20_name_7 ?>.png" alt="Оборудование Busch">
...
<h5 class="burners-modal-info__content-right_description title-desc">Технические характеристики:</h5><?= $modalPump_7_Table_20 ?>
				</div>
			</div>
		</section> 
	</main>
