<?php
	...
	$title = "$producteTitle_3_4";
	$description = "$producteDesc_3_4"; 
			...
			<div class="container">
				<div class="burners-modal-info__content">
					<div class="burners-modal-info__content-left">
						<img src="img/images/<?= $pump_4_name_3 ?>.png" alt="Оборудование Busch">
					</div>
					<div class="burners-modal-info__content-right">
						...
						<?= $modalPump_3_Desc_4 ?>
						<span class="burners-modal-info__content-right_description under-title under-title-r"><?= $modalPump_3_UnderDesc_4 ?></span>
				...
				<div class="photo-block">
					<div class="picture-performance-block picture-block">
						<img src="img/picture/<?= $pump_4_name_3 ?>.png" alt="Оборудование Busch">
						<p><?= $modalPump['pumpModalName_4'] ?></p>
					</div>
					<div class="picture-performance-block performance-block">
						<img src="img/performance/<?= $pump_4_name_3 ?>.png" alt="Оборудование Busch">
...
<h5 class="burners-modal-info__content-right_description title-desc">Технические характеристики:</h5><?= $modalPump_3_Table_4 ?>
				</div>
			</div>
		</section> 
	</main>
