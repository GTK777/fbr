<?php
	...
	$title = "$producteTitle_1_11";
	$description = "$producteDesc_1_11"; 
			...
			<div class="container">
				<div class="burners-modal-info__content">
					<div class="burners-modal-info__content-left">
						<img src="img/images/<?= $pump_11_name ?>.png" alt="Оборудование Busch">
					</div>
					<div class="burners-modal-info__content-right">
						...
						<span class="burners-modal-info__content-right_description under-title under-title-r"><?= $modalPumpUnderDesc_11 ?></span>
						<?= $modalPumpDesc_11 ?>
				...
				<div class="photo-block">
					<div class="picture-performance-block picture-block">
						<img src="img/picture/<?= $pump_11_name ?>.jpg" alt="Оборудование Busch">
						<p><?= $modalPump['pumpModalName_11'] ?></p>
					</div>
					<div class="picture-performance-block performance-block">
						<img src="img/performance/<?= $pump_11_name ?>.jpg" alt="Оборудование Busch">
						<p>Производительность: Air at 20 °C. Tolerance: ± 10% 50 Hz</p>
					</div>
				</div>
