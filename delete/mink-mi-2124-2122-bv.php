<?php
	...
	$title = "$producteTitle_2_10";
	$description = "$producteDesc_2_10"; 
			...
			<div class="container">
				<div class="burners-modal-info__content">
					<div class="burners-modal-info__content-left">
						<img src="img/images/<?= $pump_10_name_2 ?>.png" alt="Оборудование Busch">
					</div>
					<div class="burners-modal-info__content-right">
						...
						<span class="burners-modal-info__content-right_description under-title under-title-r"><?= $modalPump_2_UnderDesc_10 ?></span>
						<?= $modalPump_2_Desc_10 ?>
				...
				<div class="photo-block">
					<div class="picture-performance-block picture-block">
						<img src="img/picture/<?= $pump_10_name_2 ?>.jpg" alt="Оборудование Busch">
						<p><?= $modalPump['pumpModalName_10'] ?></p>
					</div>
					<div class="picture-performance-block performance-block">
						<img src="img/performance/<?= $pump_10_name_2 ?>.png" alt="Оборудование Busch">
...
<h5 class="burners-modal-info__content-right_description title-desc">Технические характеристики:</h5><?= $modalPump_2_Table_10 ?>
				</div>
			</div>
		</section> 
	</main>
