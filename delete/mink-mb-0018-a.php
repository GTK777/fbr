<?php
	...
	$title = "$producteTitle_2_18";
	$description = "$producteDesc_2_18"; 
				...
				<div class="bread-crumbs-content">
					<ul class="bread-crumbs-list">
						...
						<li class="bread-crumbs-item">
							...
							Busch <?= $modalPump['pumpModalName_18'] ?></a>
						</li>
					</ul> 
				</div>
			</div>
			...
			<div class="container">
				<div class="burners-modal-info__content">
					<div class="burners-modal-info__content-left">
						<img src="img/images/<?= $pump_18_name_2 ?>.png" alt="Оборудование Busch">
					</div>
					<div class="burners-modal-info__content-right">
						<h1 class="burners-modal-info__content-right_title">Вакуумный насос Busch <?= $modalPump['pumpModalName_18'] ?></h1>
						<span class="burners-modal-info__content-right_description under-title under-title-r"><?= $modalPump_2_UnderDesc_18 ?></span>
						<?= $modalPump_2_Desc_18 ?>
				...
				<div class="photo-block">
					<div class="picture-performance-block picture-block">
						<img src="img/picture/<?= $pump_18_name_2 ?>.jpg" alt="Оборудование Busch">
						<p><?= $modalPump['pumpModalName_18'] ?></p>
					</div>
					<div class="picture-performance-block performance-block">
						<img src="img/performance/<?= $pump_18_name_2 ?>.jpg" alt="Оборудование Busch">
