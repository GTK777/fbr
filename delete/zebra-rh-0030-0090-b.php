<?php
	...
	$title = "$producteTitle_1_21";
	$description = "$producteDesc_1_21"; 
			...
			<div class="container">
				<div class="burners-modal-info__content">
					<div class="burners-modal-info__content-left">
						<img src="img/images/<?= $pump_21_name ?>.png" alt="Оборудование Busch">
					</div>
					<div class="burners-modal-info__content-right">
						...
						<span class="burners-modal-info__content-right_description under-title under-title-r"><?= $modalPumpUnderDesc_21 ?></span>
						<?= $modalPumpDesc_21 ?>
				...
				<div class="photo-block">
					<div class="picture-performance-block picture-block">
						<img src="img/picture/<?= $pump_21_name ?>.png" alt="Оборудование Busch">
						<p><?= $modalPump['pumpModalName_21'] ?></p>
					</div>
					<div class="picture-performance-block performance-block">
						<img src="img/performance/<?= $pump_21_name ?>.png" alt="Оборудование Busch">
						<p>Производительность: Воздух при 21 °C. Погрешность ± 10% 50 Hz 60 Hz</p>
					</div>
				</div>
...
<h5 class="burners-modal-info__content-right_description title-desc">Технические характеристики:</h5><?= $modalPumpTable_21 ?>
