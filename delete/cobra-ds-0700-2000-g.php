<?php
	...
	$title = "$producteTitle_3_12";
	$description = "$producteDesc_3_12"; 
			...
			<div class="container">
				<div class="burners-modal-info__content">
					<div class="burners-modal-info__content-left">
						<img src="img/images/<?= $pump_12_name_3 ?>.png" alt="Оборудование Busch">
					</div>
					<div class="burners-modal-info__content-right">
						...
						<?= $modalPump_3_Desc_12 ?>
						<span class="burners-modal-info__content-right_description under-title under-title-r"><?= $modalPump_3_UnderDesc_12 ?></span>
				...
				<div class="photo-block">
					<div class="picture-performance-block picture-block">
						<img src="img/picture/<?= $pump_12_name_3 ?>.jpg" alt="Оборудование Busch">
						<p><?= $modalPump['pumpModalName_12'] ?></p>
					</div>
					<div class="picture-performance-block performance-block">
						<img src="img/performance/<?= $pump_12_name_3 ?>.jpg" alt="Оборудование Busch">
...
<h5 class="burners-modal-info__content-right_description title-desc">Технические характеристики:</h5><?= $modalPump_3_Table_12 ?>
				</div>
			</div>
		</section> 
	</main>
