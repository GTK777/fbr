<?php
	...
	$title = "$producteTitle_2_6";
	$description = "$producteDesc_2_6"; 
			...
			<div class="container">
				<div class="burners-modal-info__content">
					<div class="burners-modal-info__content-left">
						<img src="img/images/<?= $pump_6_name_2 ?>.png" alt="Оборудование Busch">
					</div>
					<div class="burners-modal-info__content-right">
						...
						<span class="burners-modal-info__content-right_description under-title under-title-r"><?= $modalPump_2_UnderDesc_6 ?></span>
						<?= $modalPump_2_Desc_6 ?>
				...
				<div class="photo-block">
					<div class="picture-performance-block picture-block">
						<img src="img/picture/<?= $pump_6_name_2 ?>.png" alt="Оборудование Busch">
						<p><?= $modalPump['pumpModalName_6'] ?></p>
					</div>
					<div class="picture-performance-block performance-block">
						<img src="img/performance/<?= $pump_6_name_2 ?>.jpg" alt="Оборудование Busch">
...
<h5 class="burners-modal-info__content-right_description title-desc">Технические характеристики:</h5><?= $modalPump_2_Table_6 ?>
				</div>
			</div>
		</section> 
	</main>
