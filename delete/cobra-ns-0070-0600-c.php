<?php
	...
	$title = "$producteTitle_3_1";
	$description = "$producteDesc_3_1"; 
			...
			<div class="container">
				<div class="burners-modal-info__content">
					<div class="burners-modal-info__content-left">
						<img src="img/images/<?= $pump_1_name_3 ?>.png" alt="Оборудование Busch">
					</div>
				...
				<div class="photo-block">
					<div class="picture-performance-block picture-block">
						<img src="img/picture/<?= $pump_1_name_3 ?>.jpg" alt="Оборудование Busch">
						<p><?= $modalPump['pumpModalName_1'] ?></p>
					</div>
					<div class="picture-performance-block performance-block">
						<img src="img/performance/<?= $pump_1_name_3 ?>.jpg" alt="Оборудование Busch">
...
<h5 class="burners-modal-info__content-right_description title-desc">Технические характеристики:</h5><?= $modalPump_3_Table_1 ?>
				</div>
			</div>
		</section> 
	</main>
