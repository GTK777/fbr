...
<?php
	...
	$title = "$producteTitle_3_23";
	$description = "$producteDesc_3_23"; 
	...
	$dataLinkAll = $dataLink['pumpModal_cobra_data'];
	
	$modalPump = $data['pumpModal_cobra'][0];
			...
			<div class="container">
				<div class="bread-crumbs-content">
					<ul class="bread-crumbs-list">
						...
						<li class="bread-crumbs-item">
							<a href="suhie-vintovye-vakuumnye-nasosy" class="bread-crumbs-link bread-crumbs-link-next bread-crumbs-link-spare-parts">Сухие винтовые вакуумные насосы</a>
						</li>
						<li class="bread-crumbs-item">
			...
			<div class="container">
				<div class="burners-modal-info__content">
					<div class="burners-modal-info__content-left">
						<img src="img/images/<?= $pump_23_name_3 ?>.png" alt="Оборудование Busch">
					</div>
					<div class="burners-modal-info__content-right">
						...
						<?= $modalPump_3_Desc_23 ?>
						<span class="burners-modal-info__content-right_description under-title under-title-r"><?= $modalPump_3_UnderDesc_23 ?></span>
						...
						<div class="content-main-line">
							<div class="main-block-link main-block-link-first"> 
								<span class="main-line-block main-line-block-first">
									<span class="main-block-link-title"><a href="http://nasosy-vakuumnye.ru/suhie-vintovye-vakuumnye-nasosy">Сухие винтовые вакуумные насосы:</a></span>
				...
				<div class="photo-block">
					<div class="picture-performance-block picture-block">
						<img src="img/picture/<?= $pump_23_name_3 ?>.jpg" alt="Оборудование Busch">
						<p><?= $modalPump['pumpModalName_23'] ?></p>
					</div>
					<div class="picture-performance-block performance-block">
						<img src="img/performance/<?= $pump_23_name_3 ?>.jpg" alt="Оборудование Busch">
...
<h5 class="burners-modal-info__content-right_description title-desc">Технические характеристики:</h5><?= $modalPump_3_Table_23 ?>
				</div>
			</div>
		</section> 
	</main>
