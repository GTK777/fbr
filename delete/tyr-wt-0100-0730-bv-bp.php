<?php
	...
	$title = "$producteTitle_6_1";
	$description = "$producteDesc_6_1"; 
	...
	$dataLinkAll = $dataLink['pumpModal_tyr_data'];
	
	$modalPump = $data['pumpModal_tyr'][0];
			...
			<div class="container">
				<div class="bread-crumbs-content">
					<ul class="bread-crumbs-list">
						...
						<li class="bread-crumbs-item">
							<a href="dvuhrotornye-vozduhoduvki" class="bread-crumbs-link bread-crumbs-link-next bread-crumbs-link-spare-parts">Двухроторные воздуходувки</a>
						</li>
						<li class="bread-crumbs-item">
			...
			<div class="container">
				<div class="burners-modal-info__content">
					<div class="burners-modal-info__content-left">
						<img src="img/images/<?= $pump_1_name_6 ?>.png" alt="Оборудование Busch">
					</div>
					<div class="burners-modal-info__content-right">
						...
						<span class="burners-modal-info__content-right_description under-title under-title-r"><?= $modalPump_6_UnderDesc_1 ?></span>
						<?= $modalPump_6_Desc_1 ?>
						...
						<div class="content-main-line">
							<div class="main-block-link main-block-link-first"> 
								<span class="main-line-block main-line-block-first">
									<span class="main-block-link-title"><a href="http://nasosy-vakuumnye.ru/dvuhrotornye-vozduhoduvki">Двухроторные воздуходувки:</a></span>
				...
				<div class="photo-block">
					<div class="picture-performance-block picture-block">
						<img src="img/picture/<?= $pump_1_name_6 ?>.png" alt="Оборудование Busch">
...
<h5 class="burners-modal-info__content-right_description title-desc">Технические характеристики:</h5><?= $modalPump_6_Table_1 ?>
