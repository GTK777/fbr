<?php
	...
	$title = "$producteTitle_4_9";
	$description = "$producteDesc_4_9"; 
	...
	$dataLinkAll = $dataLink['pumpModal_puma_and_panda_data'];
	
	$modalPump = $data['pumpModal_puma_and_panda'][0];
			...
			<div class="container">
				<div class="bread-crumbs-content">
					<ul class="bread-crumbs-list">
						...
						<li class="bread-crumbs-item">
							<a href="dvuhrotornye-busternye-vakuumnye-nasosy-rutsa" class="bread-crumbs-link bread-crumbs-link-next bread-crumbs-link-spare-parts">Двухроторные бустерные вакуумные насосы Рутса</a>
						</li>
						<li class="bread-crumbs-item">
			...
			<div class="container">
				<div class="burners-modal-info__content">
					<div class="burners-modal-info__content-left">
						<img src="img/images/<?= $pump_9_name_4 ?>.png" alt="Оборудование Busch">
					</div>
					<div class="burners-modal-info__content-right">
						...
						<?= $modalPump_4_Desc_9 ?>
						<span class="burners-modal-info__content-right_description under-title under-title-r"><?= $modalPump_4_UnderDesc_9 ?></span>
						...
						<div class="content-main-line">
							<div class="main-block-link main-block-link-first"> 
								<span class="main-line-block main-line-block-first">
									<span class="main-block-link-title"><a href="http://nasosy-vakuumnye.ru/dvuhrotornye-busternye-vakuumnye-nasosy-rutsa">Двухроторные бустерные вакуумные насосы Рутса:</a></span>
				...
				<div class="photo-block">
					<div class="picture-performance-block picture-block">
						<img src="img/picture/<?= $pump_9_name_4 ?>.jpg" alt="Оборудование Busch">
						<p><?= $modalPump['pumpModalName_9'] ?></p>
					</div>
					<div class="picture-performance-block performance-block">
						<img src="img/performance/<?= $pump_9_name_4 ?>.jpg" alt="Оборудование Busch">
...
<h5 class="burners-modal-info__content-right_description title-desc">Технические характеристики:</h5><?= $modalPump_4_Table_9 ?>
				</div>
			</div>
		</section> 
	</main>
