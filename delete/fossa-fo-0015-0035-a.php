<?php
	...
	$title = "$producteTitle_9_1";
	$description = "$producteDesc_9_1"; 
	...
	$dataLinkAll = $dataLink['pumpModal_fossa_data'];
	
	$modalPump = $data['pumpModal_fossa'][0];
			...
			<div class="container">
				<div class="bread-crumbs-content">
					<ul class="bread-crumbs-list">
						...
						<li class="bread-crumbs-item">
							<a href="spiralnye-vakuumnye-nasosy" class="bread-crumbs-link bread-crumbs-link-next bread-crumbs-link-spare-parts">Спиральные вакуумные насосы</a>
						</li>
						<li class="bread-crumbs-item">
			...
			<div class="container">
				<div class="burners-modal-info__content">
					<div class="burners-modal-info__content-left">
						<img src="img/images/<?= $pump_1_name_9 ?>.png" alt="Оборудование Busch">
					</div>
					<div class="burners-modal-info__content-right">
						...
						<span class="burners-modal-info__content-right_description under-title under-title-r"><?= $modalPump_9_UnderDesc_1 ?></span>
						<?= $modalPump_9_Desc_1 ?>
						...
						<div class="content-main-line">
							<div class="main-block-link main-block-link-first"> 
								<span class="main-line-block main-line-block-first">
									<span class="main-block-link-title"><a href="http://nasosy-vakuumnye.ru/spiralnye-vakuumnye-nasosy">Спиральные вакуумные насосы:</a></span>
				...
				<div class="photo-block">
					<div class="picture-performance-block picture-block">
						<img src="img/picture/<?= $pump_1_name_9 ?>.jpg" alt="Оборудование Busch">
						<p><?= $modalPump['pumpModalName_1'] ?></p>
					</div>
					<div class="picture-performance-block performance-block">
						<img src="img/performance/<?= $pump_1_name_9 ?>.jpg" alt="Оборудование Busch">
