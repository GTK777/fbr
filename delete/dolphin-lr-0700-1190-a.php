<?php
	...
	$title = "$producteTitle_7_26";
	$description = "$producteDesc_7_26"; 
	...
	$dataLinkAll = $dataLink['pumpModal_dolphin_data'];
	
	$modalPump = $data['pumpModal_dolphin'][0];
			...
			<div class="container">
				<div class="bread-crumbs-content">
					<ul class="bread-crumbs-list">
						...
						<li class="bread-crumbs-item">
							<a href="zhidkostno-koltsevye-nasosy-i-kompressory" class="bread-crumbs-link bread-crumbs-link-next bread-crumbs-link-spare-parts">Жидкостно-кольцевые вакуумные насосы и компрессоры</a>
						</li>
						<li class="bread-crumbs-item">
							<a href="" class="bread-crumbs-link bread-crumbs-link-now">
							Busch <?= $modalPump['pumpModalName_26'] ?></a>
						</li>
					</ul> 
				</div>
			</div>
			...
			<div class="container">
				<div class="burners-modal-info__content">
					<div class="burners-modal-info__content-left">
						<img src="img/images/<?= $pump_26_name_7 ?>.png" alt="Оборудование Busch">
					</div>
					<div class="burners-modal-info__content-right">
						<h1 class="burners-modal-info__content-right_title">Вакуумный насос Busch <?= $modalPump['pumpModalName_26'] ?></h1>
						<?= $modalPump_7_Desc_26 ?>
						<span class="burners-modal-info__content-right_description under-title under-title-r"><?= $modalPump_7_UnderDesc_26 ?></span>
						...
						<div class="content-main-line">
							<div class="main-block-link main-block-link-first"> 
								<span class="main-line-block main-line-block-first">
									<span class="main-block-link-title"><a href="http://nasosy-vakuumnye.ru/zhidkostno-koltsevye-nasosy-i-kompressory">Жидкостно-кольцевые вакуумные насосы и компрессоры:</a></span>
				...
				<div class="photo-block">
					<div class="picture-performance-block picture-block">
						<img src="img/picture/<?= $pump_26_name_7 ?>.jpg" alt="Оборудование Busch">
						<p><?= $modalPump['pumpModalName_26'] ?></p>
					</div>
					<div class="picture-performance-block performance-block">
						<img src="img/performance/<?= $pump_26_name_7 ?>.jpg" alt="Оборудование Busch">
...
<h5 class="burners-modal-info__content-right_description title-desc">Технические характеристики:</h5><?= $modalPump_7_Table_26 ?>
				</div>
			</div>
		</section> 
	</main>
