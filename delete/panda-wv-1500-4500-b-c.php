<?php
	...
	$title = "$producteTitle_4_11";
	$description = "$producteDesc_4_11"; 
				...
				<div class="bread-crumbs-content">
					<ul class="bread-crumbs-list">
						...
						<li class="bread-crumbs-item">
							...
							Busch <?= $modalPump['pumpModalName_11'] ?></a>
						</li>
					</ul> 
				</div>
			</div>
			...
			<div class="container">
				<div class="burners-modal-info__content">
					<div class="burners-modal-info__content-left">
						<img src="img/images/<?= $pump_11_name_4 ?>.png" alt="Оборудование Busch">
					</div>
					<div class="burners-modal-info__content-right">
						<h1 class="burners-modal-info__content-right_title">Вакуумный насос Busch <?= $modalPump['pumpModalName_11'] ?></h1>
						<?= $modalPump_4_Desc_11 ?>
						<span class="burners-modal-info__content-right_description under-title under-title-r"><?= $modalPump_4_UnderDesc_11 ?></span>
				...
				<div class="photo-block">
					<div class="picture-performance-block picture-block">
						<img src="img/picture/<?= $pump_11_name_4 ?>.jpg" alt="Оборудование Busch">
						<p><?= $modalPump['pumpModalName_11'] ?></p>
					</div>
					<div class="picture-performance-block performance-block">
						<img src="img/performance/<?= $pump_11_name_4 ?>.jpg" alt="Оборудование Busch">
...
<h5 class="burners-modal-info__content-right_description title-desc">Технические характеристики:</h5><?= $modalPump_4_Table_11 ?>
				</div>
			</div>
		</section> 
	</main>
