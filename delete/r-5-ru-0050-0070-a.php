<?php
	...
	$title = "$producteTitle_1_16";
	$description = "$producteDesc_1_16"; 
			...
			<div class="container">
				<div class="burners-modal-info__content">
					<div class="burners-modal-info__content-left">
						<img src="img/images/<?= $pump_16_name ?>.png" alt="Оборудование Busch">
					</div>
					<div class="burners-modal-info__content-right">
						...
						<span class="burners-modal-info__content-right_description under-title under-title-r"><?= $modalPumpUnderDesc_16 ?></span>
						<?= $modalPumpDesc_16 ?>
				...
				<div class="photo-block">
					<div class="picture-performance-block picture-block">
						<img src="img/picture/<?= $pump_16_name ?>.jpg" alt="Оборудование Busch">
						<p><?= $modalPump['pumpModalName_16'] ?></p>
					</div>
					<div class="picture-performance-block performance-block">
						<img src="img/performance/<?= $pump_16_name ?>.jpg" alt="Оборудование Busch">
