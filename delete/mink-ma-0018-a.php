<?php
	...
	$title = "$producteTitle_2_17";
	$description = "$producteDesc_2_17"; 
	...
	$dataLinkAll = $dataLink['pumpModal_mink_data'];
	
	$modalPump = $data['pumpModal_mink'][0];
			...
			<div class="container">
				<div class="bread-crumbs-content">
					<ul class="bread-crumbs-list">
						...
						<li class="bread-crumbs-item">
							<a href="suhie-kulachkovye-vakuumnye-nasosy-i-kompressory" class="bread-crumbs-link bread-crumbs-link-next bread-crumbs-link-spare-parts">Сухие кулачковые вакуумные насосы и компрессоры</a>
						</li>
						<li class="bread-crumbs-item">
							<a href="" class="bread-crumbs-link bread-crumbs-link-now">
							Busch <?= $modalPump['pumpModalName_17'] ?></a>
						</li>
					</ul> 
				</div>
			</div>
			...
			<div class="container">
				<div class="burners-modal-info__content">
					<div class="burners-modal-info__content-left">
						<img src="img/images/<?= $pump_17_name_2 ?>.png" alt="Оборудование Busch">
					</div>
					<div class="burners-modal-info__content-right">
						<h1 class="burners-modal-info__content-right_title">Вакуумный насос Busch <?= $modalPump['pumpModalName_17'] ?></h1>
						<span class="burners-modal-info__content-right_description under-title under-title-r"><?= $modalPump_2_UnderDesc_17 ?></span>
						<?= $modalPump_2_Desc_17 ?>
						...
						<div class="content-main-line">
							<div class="main-block-link main-block-link-first"> 
								<span class="main-line-block main-line-block-first">
									<span class="main-block-link-title"><a href="http://nasosy-vakuumnye.ru/suhie-kulachkovye-vakuumnye-nasosy-i-kompressory">Сухие кулачковые вакуумные насосы и компрессоры:</a></span>
                ...
                <div class="photo-block">
					<div class="picture-performance-block picture-block">
						<img src="img/picture/<?= $pump_17_name_2 ?>.jpg" alt="Оборудование Busch">
						<p><?= $modalPump['pumpModalName_17'] ?></p>
					</div>
					<div class="picture-performance-block performance-block">
						<img src="img/performance/<?= $pump_17_name_2 ?>.jpg" alt="Оборудование Busch">
				...
				<div class="specifications burners-modal-info__content-right_block-list" id="specification" role="tabpanel" aria-labelledby="specification-tab">
					 <h5 class="burners-modal-info__content-right_description title-desc">Технические характеристики:</h5>
					<?= $modalPump_2_Table_17 ?>
				</div>
			</div>
		</section> 
	</main>
