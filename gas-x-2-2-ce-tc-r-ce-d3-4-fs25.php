<?php
    ...
    $title = "$producteTitle_6_3";
    $description = "$producteDesc_6_3"; 
    ...
    $modificationModal = $modification["gazovye-gorelki-gas-x-2"][2];
    
    $modalPumpDesc = $modalPumpDesc_6_3;
    $modalPumpTable = $modalPumpTable_6_3;
?>
<!-- main block start -->
    <main class="main">
