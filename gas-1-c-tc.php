<?php
    ...
    $modificationModal = $modification["gazovye-gorelki-gas-c"][0];
    
    $modalPumpDesc = $modalPumpDesc_4_1;
    $modalPumpTable = $modalPumpTable_4_1;
?>
<!-- main block start -->
    <main class="main">
            ...
            <div class="container">
                <div class="bread-crumbs-content">
                    <ul class="bread-crumbs-list">
                        ...
                        <li class="bread-crumbs-item">
                            <a href="gazovye-gorelki-gas-c" class="bread-crumbs-link bread-crumbs-link-next bread-crumbs-link-spare-parts">F.B.R. GAS /C</a>
                        </li>
                        <li class="bread-crumbs-item">
