<?php
    ...
    $title = "$producteSectionTitle_3_7";
    $description = "$producteSectiomDescription_3_7"; 
    require "header.php";
    require "variable/data-info-finish-3.php";
    require "variable/data-description.php";

    $data = require("variable/data-info-finish-3.php");
    $burnersModal = $data["mazutnye-gorelki-fndp-m-el"];
    
    $nameBurnsPage = "F.B.R. FNDP /M EL";
?>
              ...
              <section class="section section-one section-one-text-center">
                  <div class="container">
                      ...
                      <div class="text-title-category">
                          <div class="left">
                              <p>F.B.R FNDP /M EL – это мазутные трехступенчатые наддувные горелки с электронной модуляцией. Горелка предназначена для работы с густым мазутом. Низкий шум вентилятора обеспечивается за счет специального вентилятора и защитного кожуха. </p>
                        </div>
                          <div class="right">
                              <p>Устройство работает при диапазоне 3953 до 13372  кВт. Горелка может быть установлена практически на любой вид котлов, водонагревателей и парогенераторов.</p>
