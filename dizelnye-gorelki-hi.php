         ...
         <div class="container">
             <div class="bread-crumbs-content">
              ...
              <section class="section section-one section-one-text-center">
                  <div class="container">
                      <h1>Купить дизельные промышленные горелки <?= $nameBurnsPage ?> (Ф.Б.Р.)</h1>
                      <div class="text-title-category">
                          <div class="left">
                              <p>F.B.R. HI  - это промышленные модулируемые горелки, предназначенные для отопления жилых домов и производств с повышенными теплозатратами.  Горелка двухблочная,. Для максимальной мощности используется предварительный нагрев нагнетаемого воздуха от рециркуляции.</p>
                        </div>
                          <div class="right">
