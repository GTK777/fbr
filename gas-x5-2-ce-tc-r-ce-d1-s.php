<?php
    ...
    $title = "$producteTitle_6_15";
    $description = "$producteDesc_6_15"; 
    ...
    $modificationModal = $modification["gazovye-gorelki-gas-x-2"][14];
    
    $modalPumpDesc = $modalPumpDesc_6_15;
    $modalPumpTable = $modalPumpTable_6_15;
?>
<!-- main block start -->
    <main class="main">
