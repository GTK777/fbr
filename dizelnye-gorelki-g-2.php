<?php
    ...
    $title = "$producteSectionTitle_2_13";
    $description = "$producteSectiomDescription_2_13"; 
    require "header.php";
    require "variable/data-info-finish-2.php";
    require "variable/data-description.php";

    $data = require("variable/data-info-finish-2.php");
    $burnersModal = $data["dizelnye-gorelki-g-2"];
    
    $nameBurnsPage = "F.B.R. G /2";
?>
              ...
              <section class="section section-one section-one-text-center">
                  <div class="container">
                      ...
                      <div class="text-title-category">
                          <div class="left">
                              <p>F.B.R. G/2 это дизельная двухступенчатая горелка высокой мощности. Горелка работает в диапазоне от 118 до 414 кВт и применяется для установки на котлы, печи, теплогенератоы. Горелка наддувная.   </p>
                        </div>
                          <div class="right">
                              <p>Для шумопоглощения используется защитный кожух и малошумный вентилятор.  Конструкция горелки позволит быстро получить доступ к основным узлам и механизмам при проведении сервисных работ.</p>
