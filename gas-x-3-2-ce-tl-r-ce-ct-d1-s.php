<?php
    ...
    $title = "$producteTitle_6_7";
    $description = "$producteDesc_6_7"; 
    ...
    $modificationModal = $modification["gazovye-gorelki-gas-x-2"][6];
    
    $modalPumpDesc = $modalPumpDesc_6_7;
    $modalPumpTable = $modalPumpTable_6_7;
?>
<!-- main block start -->
    <main class="main">
