<?php
    ...
    $title = "$producteSectionTitle_3_6";
    $description = "$producteSectiomDescription_3_6"; 
    require "header.php";
    require "variable/data-info-finish-3.php";
    require "variable/data-description.php";

    $data = require("variable/data-info-finish-3.php");
    $burnersModal = $data["mazutnye-gorelki-fndp-m"];
    $burnersModal2 = $data["mazutnye-gorelki-fndp-m-2"];
    
    $nameBurnsPage = "F.B.R. FNDP /M";
?>
              ...
              <section class="section section-one section-one-text-center">
                  <div class="container">
                      ...
                      <div class="text-title-category">
                          <div class="left">
                              <p>F.B.R  FNDP /M – это мазутные трехступенчатые наддувные горелки. Горелка предназначена для работы с густым мазутом. Низкий шум вентилятора обеспечивается за счет специального вентилятора и защитного кожуха. </p>
                        </div>
                          <div class="right">
                              <p>Устройство работает при диапазоне 398 до 7560 кВт. Горелка может быть установлена практически на любой вид котлов, водонагревателей и парогенераторов.</p>
