<?php
    ...
    $title = "$producteSectionTitle_2_15";
    $description = "$producteSectiomDescription_2_15"; 
    require "header.php";
    require "variable/data-info-finish-2.php";
    require "variable/data-description.php";

    $data = require("variable/data-info-finish-2.php");
    $burnersModal = $data["dizelnye-gorelki-fgp-3"];
    
    $nameBurnsPage = "F.B.R. FGP/3 ";
?>
         ...
         <div class="container">
             <div class="bread-crumbs-content">
              ...
              <section class="section section-one section-one-text-center">
                  <div class="container">
                      <h1>Купить горелки дизельные трехступенчатые <?= $nameBurnsPage ?> (Ф.Б.Р.)</h1>
                      <div class="text-title-category">
                          <div class="left">
                              <p> F.B.R.  FGP/3 - это трехступенчатая горелка работающая на дизельном топлив. Горелка предназначенная для обогрева жилых и промышленных сооружений. </p>
                        </div>
                          <div class="right">
                              <p>Устройство работает в диапазоне от 700 до 5220 кВт и характеризуется повышенной энергоэффективностью при минимальных выбросах вредного газа.</p>
