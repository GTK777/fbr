<?php
    ...
    $title = "$producteTitle_6_5";
    $description = "$producteDesc_6_5"; 
    ...
    $modificationModal = $modification["gazovye-gorelki-gas-x-2"][4];
    
    $modalPumpDesc = $modalPumpDesc_6_5;
    $modalPumpTable = $modalPumpTable_6_5;
?>
<!-- main block start -->
    <main class="main">
