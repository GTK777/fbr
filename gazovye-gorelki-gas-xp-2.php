<?php
	...
	$title = "$producteSectionTitle_1_7";
	$description = "$producteSectiomDescription_1_7"; 
	require 'header.php';
	 	...
	 	<div class="container">
	 		<div class="bread-crumbs-content">
	 			<ul class="bread-crumbs-list">
					...
					<li class="bread-crumbs-item"><a href="boilers" class="bread-crumbs-link bread-crumbs-link-now">F.B.R. GAS XP /2</a></li>
	 			</ul>
	 		</div>
	 	</div>
	 </section> 
	 		 ...
	 		 <section class="section section-one section-one-text-center">
	 		 	<div class="container">
	 		 		<h1>Купить газовые горелки F.B.R. GAS XP /2 (Ф.Б.Р.)</h1>
