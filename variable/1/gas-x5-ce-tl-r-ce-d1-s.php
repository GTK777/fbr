<?php
    ...
    $title = "$producteTitle_1_23";
    $description = "$producteDesc_1_23"; 
    ...
    $modificationModal = $modification["gazovye-gorelki-gas-x"][20];
    
    $modalPumpDesc = $modalPumpDesc_21;
    $modalPumpTable = $modalPumpTable_21;
?>
    <main class="main">
