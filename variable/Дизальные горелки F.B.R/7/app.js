...
var ds33 = ['g-0hr-2001-tc.php','g-1hr-2001-tc.php'];
...
for(var i = 0, b = 1; ds33.length > i; i++, b++) {
    ...
    '$modificationModal = $modification["dizelnye-gorelki-g-hr"][' + i + '];' + // меняем серию
    '$modalPumpDesc = $modalPumpDesc_5_7_' + b + ';' + // меняем цифру
    '$modalPumpTable = $modalPumpTable_5_7_' + b + ';' + // меняем цифру
'?>' +
'<!-- main block start -->' + 
		'<main class="main">' +
				...
				'<div class="container">' +
					'<div class="bread-crumbs-content">' +
						'<ul class="bread-crumbs-list">' +
							...
							'</li>' +
							'<li class="bread-crumbs-item">' +
								'<a href="dizelnye-gorelki-g-hr" class="bread-crumbs-link bread-crumbs-link-next bread-crumbs-link-spare-parts">F.B.R. G HR</a>' + // меняем ссылку и название
							'</li>' +
							'<li class="bread-crumbs-item">' +
