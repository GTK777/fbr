...
var ds33 =  ['g-222-r-lx-tc.php'];

for(var i = 0, b = 1; ds33.length > i; i++, b++) {
    fs.writeFile(ds33[i], '<?php' +
    ' require ' + '"variable/title-5.php";' +  
    '$title = "$producteTitle_12_' + b + '";' +  // меняем цифру
    '$description = "$producteDesc_12_' + b + '";' +  // меняем цифру
    'require "header.php";' +
    ...
    '$modificationModal = $modification["dizelnye-gorelki-g-22-rlx"][' + i + '];' + // меняем серию
    '$modalPumpDesc = $modalPumpDesc_5_12_' + b + ';' + // меняем цифру
    '$modalPumpTable = $modalPumpTable_5_12_' + b + ';' + // меняем цифру
'?>' +
'<!-- main block start -->' + 
		'<main class="main">' +
				...
				'<div class="container">' +
					'<div class="bread-crumbs-content">' +
						'<ul class="bread-crumbs-list">' +
							...
							'</li>' +
							'<li class="bread-crumbs-item">' +
								'<a href="dizelnye-gorelki-g-22-rlx" class="bread-crumbs-link bread-crumbs-link-next bread-crumbs-link-spare-parts">F.B.R. G 22 RLX</a>' + // меняем ссылку и название
							'</li>' +
							'<li class="bread-crumbs-item">' +
