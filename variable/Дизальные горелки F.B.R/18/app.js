...
var ds33 =  ['dizelnye-promyshlennye-gorelki-serii-hi.php'];

for(var i = 0, b = 1; ds33.length > i; i++, b++) {
    fs.writeFile(ds33[i], '<?php' +
    ' require ' + '"variable/title-5.php";' +  
    '$title = "$producteTitle_18_' + b + '";' +  // меняем цифру
    '$description = "$producteDesc_18_' + b + '";' +  // меняем цифру
    'require "header.php";' +
    ...
    '$modificationModal = $modification["dizelnye-gorelki-hi"][' + i + '];' + // меняем серию
    '$modalPumpDesc = $modalPumpDesc_5_18_' + b + ';' + // меняем цифру
    '$modalPumpTable = $modalPumpTable_5_18_' + b + ';' + // меняем цифру
'?>' +
'<!-- main block start -->' + 
		'<main class="main">' +
				...
				'<div class="container">' +
					'<div class="bread-crumbs-content">' +
						'<ul class="bread-crumbs-list">' +
							...
							'</li>' +
							'<li class="bread-crumbs-item">' +
								'<a href="dizelnye-gorelki-hi" class="bread-crumbs-link bread-crumbs-link-next bread-crumbs-link-spare-parts">F.B.R. HI</a>' + // меняем ссылку и название
							'</li>' +
							'<li class="bread-crumbs-item">' +
