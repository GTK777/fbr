...
var ds33 =  ['g-0sr-2003-txc.php','g-1sr-2003-tc.php'];
...
for(var i = 0, b = 1; ds33.length > i; i++, b++) {
    ...
    '$modificationModal = $modification["dizelnye-gorelki-g-sr-2003"][' + i + '];' + // меняем серию
				...
				'<div class="container">' +
					'<div class="bread-crumbs-content">' +
						'<ul class="bread-crumbs-list">' +
							...
							'</li>' +
							'<li class="bread-crumbs-item">' +
								'<a href="dizelnye-gorelki-g-sr-2003" class="bread-crumbs-link bread-crumbs-link-next bread-crumbs-link-spare-parts">F.B.R. G SR 2003</a>' + // меняем ссылку и название
							'</li>' +
							'<li class="bread-crumbs-item">' +
