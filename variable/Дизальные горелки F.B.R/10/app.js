...
var ds33 =  ['g-122-2001-tc.php','g-222-maxi.php','g-x322-tc.php','g-x322-tl.php','g-x422-tc.php','g-x422-tl.php','g-x522-tc.php','g-x522-tl.php'];
...
for(var i = 0, b = 1; ds33.length > i; i++, b++) {
    ...
    '$modificationModal = $modification["dizelnye-gorelki-g-22"][' + i + '];' + // меняем серию
    '$modalPumpDesc = $modalPumpDesc_5_10_' + b + ';' + // меняем цифру
    '$modalPumpTable = $modalPumpTable_5_10_' + b + ';' + // меняем цифру
'?>' +
'<!-- main block start -->' + 
		'<main class="main">' +
