...
var ds33 =  ['g-0s-2001-min-tc.php','g-0s-2001-thls-tc.php','g-0sr-2001-thls-tc.php'];
...
for(var i = 0, b = 1; ds33.length > i; i++, b++) {
    ...
    '$modificationModal = $modification["dizelnye-gorelki-g-thls"][' + i + '];' + // меняем серию
    '$modalPumpDesc = $modalPumpDesc_5_9_' + b + ';' + // меняем цифру
    '$modalPumpTable = $modalPumpTable_5_9_' + b + ';' + // меняем цифру
'?>' +
'<!-- main block start -->' + 
		'<main class="main">' +
				...
				'<div class="container">' +
					'<div class="bread-crumbs-content">' +
						'<ul class="bread-crumbs-list">' +
							...
							'</li>' +
							'<li class="bread-crumbs-item">' +
								'<a href="dizelnye-gorelki-g-thls" class="bread-crumbs-link bread-crumbs-link-next bread-crumbs-link-spare-parts">F.B.R. G THLS</a>' + // меняем ссылку и название
							'</li>' +
							'<li class="bread-crumbs-item">' +
