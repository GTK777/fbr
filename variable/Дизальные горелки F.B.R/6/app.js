...
var ds33 =  ['g-0h-2001-tc.php','g-1h-2001-tc.php','g-2h-maxi-tc.php','g-x3h-tc.php','g-x3h-tl.php','g-x4h-tc.php','g-x4h-tl.php','g-x5h-tc.php','g-x5h-tl.php'];
...
for(var i = 0, b = 1; ds33.length > i; i++, b++) {
    ...
    '$modificationModal = $modification["dizelnye-gorelki-g-h"][' + i + '];' + // меняем серию
    '$modalPumpDesc = $modalPumpDesc_5_6_' + b + ';' + // меняем цифру
    '$modalPumpTable = $modalPumpTable_5_6_' + b + ';' + // меняем цифру
'?>' +
'<!-- main block start -->' + 
		'<main class="main">' +
				...
				'<div class="container">' +
					'<div class="bread-crumbs-content">' +
						'<ul class="bread-crumbs-list">' +
							...
							'</li>' +
							'<li class="bread-crumbs-item">' +
								'<a href="dizelnye-gorelki-g-h" class="bread-crumbs-link bread-crumbs-link-next bread-crumbs-link-spare-parts">F.B.R. G H</a>' + // меняем ссылку и название
							'</li>' +
							'<li class="bread-crumbs-item">' +
