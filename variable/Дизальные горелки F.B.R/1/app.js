...
var ds33 =  ['g-0s-2001-tc.php','g-1s-2001-tc.php','g-2s-maxi-tc.php','g2s-maxi-tl.php','g-x3s-tc.php','g-x3s-tl.php','g-x4s-tc.php','g-x4s-tl.php','g-x5s-tc.php','g-x5s-tl.php'];
...
for(var i = 0, b = 1; ds33.length > i; i++, b++) {
    ...
    '$modificationModal = $modification["dizelnye-gorelki-g-s"][' + i + '];' + // меняем серию
				...
				'<div class="container">' +
					'<div class="bread-crumbs-content">' +
						'<ul class="bread-crumbs-list">' +
							...
							'</li>' +
							'<li class="bread-crumbs-item">' +
								'<a href="dizelnye-gorelki-g-s" class="bread-crumbs-link bread-crumbs-link-next bread-crumbs-link-spare-parts">F.B.R. G S</a>' + // меняем ссылку и название
							'</li>' +
							'<li class="bread-crumbs-item">' +
