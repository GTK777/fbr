...
var ds33 =  ['fgp-750-m-tl-ec.php','fgp-1000-m-tl-ec.php','fgp-1250-m-tl-ec.php'];

for(var i = 0, b = 1; ds33.length > i; i++, b++) {
    fs.writeFile(ds33[i], '<?php' +
    ' require ' + '"variable/title-5.php";' +  
    '$title = "$producteTitle_17_' + b + '";' +  // меняем цифру
    '$description = "$producteDesc_17_' + b + '";' +  // меняем цифру
    'require "header.php";' +
    ...
    '$modificationModal = $modification["dizelnye-gorelki-fgp-m-el"][' + i + '];' + // меняем серию
    '$modalPumpDesc = $modalPumpDesc_5_17_' + b + ';' + // меняем цифру
    '$modalPumpTable = $modalPumpTable_5_17_' + b + ';' + // меняем цифру
'?>' +
'<!-- main block start -->' + 
		'<main class="main">' +
				...
				'<div class="container">' +
					'<div class="bread-crumbs-content">' +
						'<ul class="bread-crumbs-list">' +
							...
							'</li>' +
							'<li class="bread-crumbs-item">' +
								'<a href="dizelnye-gorelki-fgp-m-el" class="bread-crumbs-link bread-crumbs-link-next bread-crumbs-link-spare-parts">F.B.R. FGP /M EL	</a>' + // меняем ссылку и название
							'</li>' +
							'<li class="bread-crumbs-item">' +
