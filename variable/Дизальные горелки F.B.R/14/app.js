...
var ds33 =  ['fgp-50-2-tc.php','fgp-50-2-tl.php','fgp-50-2-tc-evo.php','fgp-70-2-tc.php','fgp-70-2-tl.php','fgp-100-2-tc.php','fgp-100-2-tl.php','fgp-120-2-tc.php','fgp-120-2-tl.php','fgp-150-2-tc.php','fgp-150-2-tl.php'];

for(var i = 0, b = 1; ds33.length > i; i++, b++) {
    fs.writeFile(ds33[i], '<?php' +
    ' require ' + '"variable/title-5.php";' +  
    '$title = "$producteTitle_14_' + b + '";' +  // меняем цифру
    '$description = "$producteDesc_14_' + b + '";' +  // меняем цифру
    'require "header.php";' +
    ...
    '$modificationModal = $modification["dizelnye-gorelki-fgp-2"][' + i + '];' + // меняем серию
    '$modalPumpDesc = $modalPumpDesc_5_14_' + b + ';' + // меняем цифру
    '$modalPumpTable = $modalPumpTable_5_14_' + b + ';' + // меняем цифру
'?>' +
'<!-- main block start -->' + 
		'<main class="main">' +
				...
				'<div class="container">' +
					'<div class="bread-crumbs-content">' +
						'<ul class="bread-crumbs-list">' +
							...
							'</li>' +
							'<li class="bread-crumbs-item">' +
								'<a href="dizelnye-gorelki-fgp-2" class="bread-crumbs-link bread-crumbs-link-next bread-crumbs-link-spare-parts">F.B.R. FGP/2</a>' + // меняем ссылку и название
							'</li>' +
							'<li class="bread-crumbs-item">' +
