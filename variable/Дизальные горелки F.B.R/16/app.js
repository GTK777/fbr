...
var ds33 =  ['fgp-50-m-tc.php','fgp-50-m-tl.php','fgp-70-m-tck.php','fgp-70-m-tl.php','fgp-100-m-tck.php','fgp-100-m-tlk.php','fgp-120-m-tc.php','fgp-120-m-tl.php','fgp-150-m-tc.php','fgp-150-m-tl.php','fgp-190-m-tl-mec.php','fgp-250-m-tl-mec.php','fgp-350-m-tl-mec.php','fgp-450-m-tl-mec.php','fgp-550-m-tl-mec.php','fgp-650-m-tl-mec.php'];

for(var i = 0, b = 1; ds33.length > i; i++, b++) {
    fs.writeFile(ds33[i], '<?php' +
    ' require ' + '"variable/title-5.php";' +  
    '$title = "$producteTitle_16_' + b + '";' +  // меняем цифру
    '$description = "$producteDesc_16_' + b + '";' +  // меняем цифру
    'require "header.php";' +
    ...
    '$modificationModal = $modification["dizelnye-gorelki-fgp-m"][' + i + '];' + // меняем серию
    '$modalPumpDesc = $modalPumpDesc_5_16_' + b + ';' + // меняем цифру
    '$modalPumpTable = $modalPumpTable_5_16_' + b + ';' + // меняем цифру
'?>' +
'<!-- main block start -->' + 
		'<main class="main">' +
				...
				'<div class="container">' +
					'<div class="bread-crumbs-content">' +
						'<ul class="bread-crumbs-list">' +
							...
							'</li>' +
							'<li class="bread-crumbs-item">' +
								'<a href="dizelnye-gorelki-fgp-m" class="bread-crumbs-link bread-crumbs-link-next bread-crumbs-link-spare-parts">F.B.R. FGP M</a>' + // меняем ссылку и название
							'</li>' +
							'<li class="bread-crumbs-item">' +
