...
var ds33 =  ['g-0sr-lx-tc.php','g-1sr-lx.php','g-0sr-lx-txc.php'];
...
for(var i = 0, b = 1; ds33.length > i; i++, b++) {
    ...
    '$modificationModal = $modification["dizelnye-gorelki-g-sr-lx"][' + i + '];' + // меняем серию
				...
				'<div class="container">' +
					'<div class="bread-crumbs-content">' +
						'<ul class="bread-crumbs-list">' +
							...
							'</li>' +
							'<li class="bread-crumbs-item">' +
								'<a href="dizelnye-gorelki-g-sr-lx" class="bread-crumbs-link bread-crumbs-link-next bread-crumbs-link-spare-parts">F.B.R. G SR LX</a>' + // меняем ссылку и название
							'</li>' +
							'<li class="bread-crumbs-item">' +
