...
var ds33 =  ['fgp-190-3-tl.php','fgp-250-3-tl.php','fgp-350-3-tl.php','fgp-450-3-tl.php'];

for(var i = 0, b = 1; ds33.length > i; i++, b++) {
    fs.writeFile(ds33[i], '<?php' +
    ' require ' + '"variable/title-5.php";' +  
    '$title = "$producteTitle_15_' + b + '";' +  // меняем цифру
    '$description = "$producteDesc_15_' + b + '";' +  // меняем цифру
    'require "header.php";' +
    ...
    '$modificationModal = $modification["dizelnye-gorelki-fgp-3"][' + i + '];' + // меняем серию
    '$modalPumpDesc = $modalPumpDesc_5_15_' + b + ';' + // меняем цифру
    '$modalPumpTable = $modalPumpTable_5_15_' + b + ';' + // меняем цифру
'?>' +
'<!-- main block start -->' + 
		'<main class="main">' +
				...
				'<div class="container">' +
					'<div class="bread-crumbs-content">' +
						'<ul class="bread-crumbs-list">' +
							...
							'</li>' +
							'<li class="bread-crumbs-item">' +
								'<a href="dizelnye-gorelki-fgp-3" class="bread-crumbs-link bread-crumbs-link-next bread-crumbs-link-spare-parts">F.B.R. FGP/2</a>' + // меняем ссылку и название
							'</li>' +
							'<li class="bread-crumbs-item">' +
