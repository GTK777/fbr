...
var ds33 =  ['gm-x-0-tc-r-ce-d1-2-s.php','gm-x-0-tl-r-ce-d1-2-s.php','gm-x-1-tc-r-ce-d1-2-s.php','gm-x-1-tl-r-ce-d1-2-s.php','gm-x-3-tc-r-ce-d1-s.php','gm-x-3-tl-r-ce-d1-s.php','gm-x-4-tc-r-ce-d1-s.php','gm-x-4-tl-r-ce-d1-s.php','gm-x-3-tc-r-ce-ct-d1-s.php','gm-x-3-tl-r-ce-ct-d1-s.php','gm-x-4-tc-r-ce-ct-d1-s.php','gm-x-4-tl-r-ce-ct-d1-.php'];
				...
				'<div class="container">' +
					'<div class="bread-crumbs-content">' +
						'<ul class="bread-crumbs-list">' +
							...
							'</li>' +
							'<li class="bread-crumbs-item">' +
								'<a href="gazodizelnye-gorelki-gm-x" class="bread-crumbs-link bread-crumbs-link-next bread-crumbs-link-spare-parts">F.B.R. GM X</a>' + // меняем ссылку и название
							'</li>' +
							'<li class="bread-crumbs-item">' +
