...
var ds33 =  ['gazodizelnye-gorelki-hi-k-m-tl.php'];
...
for(var i = 0, b = 1; ds33.length > i; i++, b++) {
    ...
    '$modificationModal = $modification["gazodizelnye-gorelki-hi"][' + i + '];' + // меняем серию
    '$modalPumpDesc = $modalPumpDesc_5_5_' + b + ';' + // меняем цифру
    '$modalPumpTable = $modalPumpTable_5_5_' + b + ';' + // меняем цифру
'?>' +
'<!-- main block start -->' + 
		'<main class="main">' +
				...
				'<div class="container">' +
					'<div class="bread-crumbs-content">' +
						'<ul class="bread-crumbs-list">' +
							...
							'</li>' +
							'<li class="bread-crumbs-item">' +
								'<a href="gazodizelnye-gorelki-hi" class="bread-crumbs-link bread-crumbs-link-next bread-crumbs-link-spare-parts">F.B.R. HI</a>' + // меняем ссылку и название
							'</li>' +
							'<li class="bread-crumbs-item">' +
