...
var ds33 =  ['k750-m-tl-el-r-ce-ct-dn65-s-f65.php','k750-m-tl-el-r-ce-ct-dn80-s-f80.php','k750-m-tl-el-r-ce-ct-dn100-s-f100.php','k1000-m-tl-el-r-ce-ct-dn80-s-f80.php','k1000-m-tl-el+-r-ce-ct-dn100-s-f100.php','k750-m-tl-el-r-ce-ct-dn125-s-f125.php','k1000-m-tl-el+-r-ce-ct-dn125-s-f125.php','k1250-m-tl-el-r-ce-ct-dn80-s-f80.php','k1250-m-tl-el+-r-ce-ct-dn100-s-f100.php','k1250-m-tl-el+-r-ce-ct-dn125-s-f12.php'];

for(var i = 0, b = 1; ds33.length > i; i++, b++) {
    fs.writeFile(ds33[i], '<?php' +
    ' require ' + '"variable/title-3.php";' +  
    '$title = "$producteTitle_4_' + b + '";' +  // меняем цифру
    '$description = "$producteDesc_4_' + b + '";' +  // меняем цифру
    'require "header.php";' +
    ...
    '$modificationModal = $modification["gazodizelnye-gorelki-k-m-el"][' + i + '];' + // меняем серию
    '$modalPumpDesc = $modalPumpDesc_5_4_' + b + ';' + // меняем цифру
    '$modalPumpTable = $modalPumpTable_5_4_' + b + ';' + // меняем цифру
'?>' +
'<!-- main block start -->' + 
		'<main class="main">' +
				...
				'<div class="container">' +
					'<div class="bread-crumbs-content">' +
						'<ul class="bread-crumbs-list">' +
							...
							'</li>' +
							'<li class="bread-crumbs-item">' +
								'<a href="gazodizelnye-gorelki-k-m-el" class="bread-crumbs-link bread-crumbs-link-next bread-crumbs-link-spare-parts">F.B.R. K /M EL</a>' + // меняем ссылку и название
							'</li>' +
							'<li class="bread-crumbs-item">' +
				...
				'<div class="container">' +
					...
					'<div class="burners-modal-info__content">' +
						'<div class="burners-modal-info__content-left">' +
							'<img src="img/images/gazodizelnye-gorelki-k-m-el.jpg" alt="<?= $modificationModal["burnersModalName"] ?>">' +
						'</div>' +
