<?php
    ...
    $title = "$producteTitle_6_14";
    $description = "$producteDesc_6_14"; 
    ...
    $modificationModal = $modification["gazovye-gorelki-gas-x-2"][13];
    
    $modalPumpDesc = $modalPumpDesc_6_14;
    $modalPumpTable = $modalPumpTable_6_14;
?>
<!-- main block start -->
    <main class="main">
