<?php
    ...
    $title = "$producteTitle_6_8";
    $description = "$producteDesc_6_8"; 
    ...
    $modificationModal = $modification["gazovye-gorelki-gas-x-2"][7];
    
    $modalPumpDesc = $modalPumpDesc_6_8;
    $modalPumpTable = $modalPumpTable_6_8;
?>
<!-- main block start -->
    <main class="main">
