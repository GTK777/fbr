<?php
    ...
    $title = "$producteTitle_6_9";
    $description = "$producteDesc_6_9"; 
    ...
    $modificationModal = $modification["gazovye-gorelki-gas-x-2"][8];
    
    $modalPumpDesc = $modalPumpDesc_6_9;
    $modalPumpTable = $modalPumpTable_6_9;
?>
<!-- main block start -->
    <main class="main">
