<?php
    ...
    $title = "$producteTitle_6_6";
    $description = "$producteDesc_6_6"; 
    ...
    $modificationModal = $modification["gazovye-gorelki-gas-x-2"][5];
    
    $modalPumpDesc = $modalPumpDesc_6_6;
    $modalPumpTable = $modalPumpTable_6_6;
?>
<!-- main block start -->
    <main class="main">
