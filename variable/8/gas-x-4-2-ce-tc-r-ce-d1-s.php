<?php
    ...
    $title = "$producteTitle_6_10";
    $description = "$producteDesc_6_10"; 
    ...
    $modificationModal = $modification["gazovye-gorelki-gas-x-2"][9];
    
    $modalPumpDesc = $modalPumpDesc_6_10;
    $modalPumpTable = $modalPumpTable_6_10;
?>
<!-- main block start -->
    <main class="main">
