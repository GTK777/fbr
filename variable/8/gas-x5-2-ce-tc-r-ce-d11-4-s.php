<?php
    ...
    $title = "$producteTitle_6_16";
    $description = "$producteDesc_6_16"; 
    ...
    $modificationModal = $modification["gazovye-gorelki-gas-x-2"][15];
    
    $modalPumpDesc = $modalPumpDesc_6_16;
    $modalPumpTable = $modalPumpTable_6_16;
?>
<!-- main block start -->
    <main class="main">
