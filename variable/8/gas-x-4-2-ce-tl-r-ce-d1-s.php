<?php
    ...
    $title = "$producteTitle_6_12";
    $description = "$producteDesc_6_12"; 
    ...
    $modificationModal = $modification["gazovye-gorelki-gas-x-2"][11];
    
    $modalPumpDesc = $modalPumpDesc_6_12;
    $modalPumpTable = $modalPumpTable_6_12;
?>
<!-- main block start -->
    <main class="main">
