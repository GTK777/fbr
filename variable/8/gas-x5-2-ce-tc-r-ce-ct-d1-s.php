<?php
    ...
    $title = "$producteTitle_6_13";
    $description = "$producteDesc_6_13"; 
    ...
    $modificationModal = $modification["gazovye-gorelki-gas-x-2"][12];
    
    $modalPumpDesc = $modalPumpDesc_6_13;
    $modalPumpTable = $modalPumpTable_6_13;
?>
<!-- main block start -->
    <main class="main">
