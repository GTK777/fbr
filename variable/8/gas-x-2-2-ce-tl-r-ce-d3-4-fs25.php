<?php
    ...
    $title = "$producteTitle_6_4";
    $description = "$producteDesc_6_4"; 
    ...
    $modificationModal = $modification["gazovye-gorelki-gas-x-2"][3];
    
    $modalPumpDesc = $modalPumpDesc_6_4;
    $modalPumpTable = $modalPumpTable_6_4;
?>
<!-- main block start -->
    <main class="main">
