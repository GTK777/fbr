<?php
    ...
    $title = "$producteTitle_1_24";
    $description = "$producteDesc_1_24"; 
    ...
    $modificationModal = $modification["gazovye-gorelki-gas-x"][21];
    
    $modalPumpDesc = $modalPumpDesc_22;
    $modalPumpTable = $modalPumpTable_22;
?>
    <main class="main">
