...
var ds33 =  ['gas-x0-ce-tc-r-ce-d1-2-s.php','gas-x0-ce-tl-r-ce-d1-2-s.php','gas-x1-ce-tc-r-ce-d1-2-s.php','gas-x1-ce-tl-r-ce-d1-2-s.php','gas-x2-ce-tc-r-ce-d3-4-s.php','gas-x2-ce-tl-r-ce-d3-4-s.php','gas-x3-ce-tc-r-ce-d1-s.php','gas-x3-ce-tl-r-ce-d1-s.php','gas-x3-ce-tc-r-ce-ct-d1-s.php','gas-x3-ce-tl-r-ce-ct-d1-s.php','gas-x4-ce-tc-r-ce-d1-s.php','gas-x4-ce-tl-r-ce-d1-s.php','gas-x4-ce-tc-r-ce-ct-d1-s.php','gas-x4-ce-tl-r-ce-ct-d1-s.php','gas-x5-ce-tc-r-ce-d1-s.php','gas-x5-ce-tl-r-ce-d1-s.php','gas-x5-ce-tc-r-ce-d11-4-s.php','gas-x5-ce-tc-r-ce-ct-d1-s.php','gas-x5-ce-tl-r-ce-d11-4-s.php','gas-x5-ce-tl-r-ce-ct-d1-s.php','gas-x5-ce-tc-r-ce-ct-d11-4-s.php','gas-x5-ce-tl-r-ce-ct-d11-4-s.php'];
...
for(var i = 0, b = 1; ds33.length > i; i++, b++) {
    ...
    '$modificationModal = $modification["gazovye-gorelki-gas-x"][' + i + '];' + // меняем серию
    '$modalPumpDesc = $modalPumpDesc_1_' + b + ';' + // меняем цифру
    '$modalPumpTable = $modalPumpTable_1_' + b + ';' + // меняем цифру
'?>' +
'<!-- main block start -->' + 
		'<main class="main">' +
				...
				'<div class="container">' +
					'<div class="bread-crumbs-content">' +
						'<ul class="bread-crumbs-list">' +
							...
							'</li>' +
							'<li class="bread-crumbs-item">' +
								'<a href="gazovye-gorelki-gas-x" class="bread-crumbs-link bread-crumbs-link-next bread-crumbs-link-spare-parts">F.B.R. GAS X</a>' + // меняем ссылку и название
							'</li>' +
							'<li class="bread-crumbs-item">' +
