<?php
    ...
    $modificationModal = $modification["gazovye-gorelki-gas-xp"][10];
    
    $modalPumpDesc = $modalPumpDesc_3_11;
    $modalPumpTable = $modalPumpTable_3_11;
?>
<!-- main block start -->
    <main class="main">
            ...
            <div class="container">
                <div class="bread-crumbs-content">
                    <ul class="bread-crumbs-list">
                        ...
                        <li class="bread-crumbs-item">
                            <a href="gazovye-gorelki-gas-xp" class="bread-crumbs-link bread-crumbs-link-next bread-crumbs-link-spare-parts">F.B.R. GAS XP</a>
                        </li>
                        <li class="bread-crumbs-item">
