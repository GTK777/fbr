...
var ds33 =  ['gas-x-1-2-ce-tc-r-ce-d1-2-s.php','gas-x-1-2-ce-tl-r-ce-d1-2-s.php','gas-x-2-2-ce-tc-r-ce-d3-4-fs25.php','gas-x-2-2-ce-tl-r-ce-d3-4-fs25.php','gas-x-3-2-ce-tc-r-ce-d1-s.php','gas-x-3-2-ce-tl-r-ce-d1-s.php','gas-x-3-2-ce-tc-r-ce-ct-d1-s.php','gas-x-3-2-ce-tl-r-ce-ct-d1-s.php','gas-x-4-2-ce-tc-r-ce-d1-s.php','gas-x-4-2-ce-tl-r-ce-d1-s.php','gas-x-4-2-ce-tc-r-ce-ct-d1-s.php','gas-x-4-2-ce-tl-r-ce-ct-d1-s.php','gas-x5-2-ce-tc-r-ce-d1-s.php','gas-x5-2-ce-tl-r-ce-d1-s.php','gas-x5-2-ce-tc-r-ce-d11-4-s.php','gas-x5-2-ce-tl-r-ce-d11-4-s.php','gas-x5-2-ce-tc-r-ce-ct-d1-s.php','gas-x5-2-ce-tl-r-ce-ct-d1-s.php','gas-x5-2-ce-tc-r-ce-ct-d11-4-s.php','gas-x5-2-ce-tl-r-ce-ct-d11-4-s.php'];

for(var i = 0, b = 1; ds33.length > i; i++, b++) {
    fs.writeFile(ds33[i], '<?php' +
    ' require ' + '"variable/title.php";' +  
    '$title = "$producteTitle_6_' + b + '";' +  // меняем цифру
    '$description = "$producteDesc_6_' + b + '";' +  // меняем цифру
    'require "header.php";' +
    ...
    '$modificationModal = $modification["gazovye-gorelki-gas-x-2"][' + i + '];' + // меняем серию
    '$modalPumpDesc = $modalPumpDesc_6_' + b + ';' + // меняем цифру
    '$modalPumpTable = $modalPumpTable_6_' + b + ';' + // меняем цифру
'?>' +
'<!-- main block start -->' + 
		'<main class="main">' +
				...
				'<div class="container">' +
					'<div class="bread-crumbs-content">' +
						'<ul class="bread-crumbs-list">' +
							...
							'</li>' +
							'<li class="bread-crumbs-item">' +
								'<a href="gazovye-gorelki-gas-x-2" class="bread-crumbs-link bread-crumbs-link-next bread-crumbs-link-spare-parts">F.B.R. GAS X /2</a>' + // меняем ссылку и название
							'</li>' +
							'<li class="bread-crumbs-item">' +
