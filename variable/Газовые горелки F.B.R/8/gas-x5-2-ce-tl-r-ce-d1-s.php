<?php
    ...
    $title = "$producteTitle_6_19";
    $description = "$producteDesc_6_19"; 
    ...
    $modificationModal = $modification["gazovye-gorelki-gas-x-2"][18];
    
    $modalPumpDesc = $modalPumpDesc_6_19;
    $modalPumpTable = $modalPumpTable_6_19;
?>
<!-- main block start -->
    <main class="main">
