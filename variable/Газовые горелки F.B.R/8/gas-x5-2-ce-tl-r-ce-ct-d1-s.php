<?php
    ...
    $title = "$producteTitle_6_17";
    $description = "$producteDesc_6_17"; 
    ...
    $modificationModal = $modification["gazovye-gorelki-gas-x-2"][16];
    
    $modalPumpDesc = $modalPumpDesc_6_17;
    $modalPumpTable = $modalPumpTable_6_17;
?>
<!-- main block start -->
    <main class="main">
