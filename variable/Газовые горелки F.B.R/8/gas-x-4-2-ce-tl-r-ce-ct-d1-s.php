<?php
    ...
    $title = "$producteTitle_6_11";
    $description = "$producteDesc_6_11"; 
    ...
    $modificationModal = $modification["gazovye-gorelki-gas-x-2"][10];
    
    $modalPumpDesc = $modalPumpDesc_6_11;
    $modalPumpTable = $modalPumpTable_6_11;
?>
<!-- main block start -->
    <main class="main">
