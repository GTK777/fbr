<?php
    ...
    $title = "$producteTitle_6_2";
    $description = "$producteDesc_6_2"; 
    ...
    $modificationModal = $modification["gazovye-gorelki-gas-x-2"][1];
    
    $modalPumpDesc = $modalPumpDesc_6_2;
    $modalPumpTable = $modalPumpTable_6_2;
?>
<!-- main block start -->
    <main class="main">
