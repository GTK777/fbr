...
var ds33 =  ['gas-xp-60-m-ce-tc-r-ce-d1-s.php','gas-xp-60-m-ce-tl-r-ce-d1-s.php','gas-xp-60-m-ce-tc-r-ce-d11-2-fs40.php','gas-xp-60-m-ce-tl-r-ce-d11-2-fs40.php','gas-xp-60-m-ce-tc-r-ce-d11-2-fs50.php','gas-xp-60-m-ce-tl-r-ce-d11-2-fs50.php','gas-xp-60-m-ce-tc-r-ce-ct-d1-s.php','gas-xp-60-m-ce-tl-r-ce-ct-d1-s.php','gas-xp-60-m-ce-tc-r-ce-ct-d11-2-fs40.php','gas-xp-60-m-ce-tl-r-ce-ct-d11-2-fs40.php','gas-xp-60-m-ce-tc-r-ce-ct-d11-2-fs50.php','gas-xp-60-m-ce-tl-r-ce-ct-d11-2-fs50.php'];

for(var i = 0, b = 1; ds33.length > i; i++, b++) {
    fs.writeFile(ds33[i], '<?php' +
    ' require ' + '"variable/title.php";' +  
    '$title = "$producteTitle_10_' + b + '";' +  // меняем цифру
    '$description = "$producteDesc_10_' + b + '";' +  // меняем цифру
    'require "header.php";' +
    ...
    '$modificationModal = $modification["gazovye-gorelki-gas-xp-m"][' + i + '];' + // меняем серию
    '$modalPumpDesc = $modalPumpDesc_10_' + b + ';' + // меняем цифру
    '$modalPumpTable = $modalPumpTable_10_' + b + ';' + // меняем цифру
'?>' +
'<!-- main block start -->' + 
		'<main class="main">' +
				...
				'<div class="container">' +
					'<div class="bread-crumbs-content">' +
						'<ul class="bread-crumbs-list">' +
							...
							'</li>' +
							'<li class="bread-crumbs-item">' +
								'<a href="gazovye-gorelki-gas-xp-m" class="bread-crumbs-link bread-crumbs-link-next bread-crumbs-link-spare-parts">F.B.R. GAS XP /M</a>' + // меняем ссылку и название
							'</li>' +
							'<li class="bread-crumbs-item">' +
				...
				'<div class="container">' +
					...
					'<div class="burners-modal-info__content">' +
						'<div class="burners-modal-info__content-left">' +
							'<img src="img/images/gazovye-gorelki-gas-xp-m.png" alt="Горелки FBR">' +
						'</div>' +
