...
var ds33 =  ['hi-gas-p190-m-ce-tl.php','hi-gas-p250-m-ce-tl.php','hi-gas-p300-m-ce-tl.php','hi-gas-p350-m-ce-tl.php','hi-gas-p450-m-ce-tl.php','hi-gas-p550-m-ce-tl.php','hi-gas-p650-m-ce-tl.php','hi-gas-p750-m-ce-tl.php','hi-gas-p1000-m-ce-tl.php','hi-gas-p1300-m-ce-tl.php','hi-gas-p1500-m-ce-tl.php','hi-gas-p1800-m-ce-tl.php'];
...
for(var i = 0, b = 1; ds33.length > i; i++, b++) {
    ...
    '$modificationModal = $modification["gazovye-gorelki-hi"][' + i + '];' + // меняем серию
    '$modalPumpDesc = $modalPumpDesc_13_' + b + ';' + // меняем цифру
    '$modalPumpTable = $modalPumpTable_13_' + b + ';' + // меняем цифру
'?>' +
'<!-- main block start -->' + 
		'<main class="main">' +
				...
				'<div class="container">' +
					'<div class="bread-crumbs-content">' +
						'<ul class="bread-crumbs-list">' +
							...
							'</li>' +
							'<li class="bread-crumbs-item">' +
								'<a href="gazovye-gorelki-hi" class="bread-crumbs-link bread-crumbs-link-next bread-crumbs-link-spare-parts">F.B.R. HI</a>' + // меняем ссылку и название
							'</li>' +
							'<li class="bread-crumbs-item">' +
				...
				'<div class="container">' +
					...
					'<div class="burners-modal-info__content">' +
						'<div class="burners-modal-info__content-left">' +
							'<img src="img/images/gazovye-gorelki-hi.jpg" alt="Горелки FBR">' +
						'</div>' +
