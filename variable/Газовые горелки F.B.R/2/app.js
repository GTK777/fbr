...
var ds33 =  ['gas-x-1-ce-f-r-ce-d1-2-s.php','gas-x-2-ce-f-r-ce-d3-4-s.php','gas-x-3-ce-f-r-ce-d1-s.php','gas-x-4-ce-f-r-ce-d1-s.php','gas-x-3-ce-f-r-ce-ct-d1-s.php','gas-x-4-ce-f-r-ce-ct-d1-s.php'];
...
for(var i = 0, b = 1; ds33.length > i; i++, b++) {
    ...
    '$modificationModal = $modification["gazovye-gorelki-gas-x-f"][' + i + '];' + // меняем серию
    '$modalPumpDesc = $modalPumpDesc_2_' + b + ';' + // меняем цифру
    '$modalPumpTable = $modalPumpTable_2_' + b + ';' + // меняем цифру
'?>' +
'<!-- main block start -->' + 
		'<main class="main">' +
				...
				'<div class="container">' +
					'<div class="bread-crumbs-content">' +
						'<ul class="bread-crumbs-list">' +
							...
							'</li>' +
							'<li class="bread-crumbs-item">' +
								'<a href="gazovye-gorelki-gas-x-f" class="bread-crumbs-link bread-crumbs-link-next bread-crumbs-link-spare-parts">F.B.R. GAS X F</a>' + // меняем ссылку и название
							'</li>' +
							'<li class="bread-crumbs-item">' +
