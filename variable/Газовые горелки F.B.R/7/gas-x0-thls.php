<?php
    ...
    $modificationModal = $modification["gazovye-gorelki-gas-thls"][0];
    
    $modalPumpDesc = $modalPumpDesc_5_1;
    $modalPumpTable = $modalPumpTable_5_1;
?>
<!-- main block start -->
    <main class="main">
            ...
            <div class="container">
                <div class="bread-crumbs-content">
                    <ul class="bread-crumbs-list">
                        ...
                        <li class="bread-crumbs-item">
                            <a href="gazovye-gorelki-gas-thls" class="bread-crumbs-link bread-crumbs-link-next bread-crumbs-link-spare-parts">F.B.R. GAS X0 THLS</a>
                        </li>
                        <li class="bread-crumbs-item">
