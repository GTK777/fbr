...
var ds33 =  ['gas-xp-60-2-ce-tc-r-ce-d1-s.php','gas-xp-60-2-ce-tl-r-ce-d1-s.php','gas-xp-60-2-ce-tc-r-ce-d11-2-fs40.php','gas-xp-60-2-ce-tl-r-ce-d11-2-fs40.php','gas-xp-60-2-ce-tc-r-ce-d11-2-fs50.php','gas-xp-60-2-ce-tl-r-ce-d11-2-fs50.php','gas-xp-60-2-ce-tc-r-ce-ct-d1-s.php','gas-xp-60-2-ce-tl-r-ce-ct-d1-s.php','gas-xp-60-2-ce-tc-r-ce-ct-d11-2-fs40.php','gas-xp-60-2-ce-tl-r-ce-ct-d11-2-fs40.php','gas-xp-60-2-ce-tc-r-ce-ct-d11-2-fs50.php','gas-xp-60-2-ce-tl-r-ce-ct-d11-2-fs50.php'];

for(var i = 0, b = 1; ds33.length > i; i++, b++) {
    fs.writeFile(ds33[i], '<?php' +
    ' require ' + '"variable/title.php";' +  
    '$title = "$producteTitle_7_' + b + '";' +  // меняем цифру
    '$description = "$producteDesc_7_' + b + '";' +  // меняем цифру
    'require "header.php";' +
    ...
    '$modificationModal = $modification["gazovye-gorelki-gas-xp-2"][' + i + '];' + // меняем серию
    '$modalPumpDesc = $modalPumpDesc_7_' + b + ';' + // меняем цифру
    '$modalPumpTable = $modalPumpTable_7_' + b + ';' + // меняем цифру
'?>' +
'<!-- main block start -->' + 
		'<main class="main">' +
				...
				'<div class="container">' +
					'<div class="bread-crumbs-content">' +
						'<ul class="bread-crumbs-list">' +
							...
							'</li>' +
							'<li class="bread-crumbs-item">' +
								'<a href="gazovye-gorelki-gas-xp-2" class="bread-crumbs-link bread-crumbs-link-next bread-crumbs-link-spare-parts">F.B.R. GAS XP /2</a>' + // меняем ссылку и название
							'</li>' +
							'<li class="bread-crumbs-item">' +
