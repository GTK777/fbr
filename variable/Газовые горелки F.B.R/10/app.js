...
for(var i = 0, b = 1; ds33.length > i; i++, b++) {
    ...
    '$modificationModal = $modification["gazovye-gorelki-gas-p-2"][' + i + '];' + // меняем серию
    '$modalPumpDesc = $modalPumpDesc_8_' + b + ';' + // меняем цифру
    '$modalPumpTable = $modalPumpTable_8_' + b + ';' + // меняем цифру
'?>' +
'<!-- main block start -->' + 
		'<main class="main">' +
				...
				'<div class="container">' +
					'<div class="bread-crumbs-content">' +
						'<ul class="bread-crumbs-list">' +
							...
							'</li>' +
							'<li class="bread-crumbs-item">' +
								'<a href="gazovye-gorelki-gas-p-2" class="bread-crumbs-link bread-crumbs-link-next bread-crumbs-link-spare-parts">F.B.R. GAS P /2</a>' + // меняем ссылку и название
							'</li>' +
							'<li class="bread-crumbs-item">' +
