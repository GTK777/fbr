<?php
    ...
    $modificationModal = $modification["gazovye-gorelki-gas-xp-2"][10];
    
    $modalPumpDesc = $modalPumpDesc_7_11;
    $modalPumpTable = $modalPumpTable_7_11;
?>
<!-- main block start -->
    <main class="main">
            ...
            <div class="container">
                <div class="bread-crumbs-content">
                    <ul class="bread-crumbs-list">
                        ...
                        <li class="bread-crumbs-item">
                            <a href="gazovye-gorelki-gas-xp-2" class="bread-crumbs-link bread-crumbs-link-next bread-crumbs-link-spare-parts">F.B.R. GAS XP /2</a>
                        </li>
                        <li class="bread-crumbs-item">
