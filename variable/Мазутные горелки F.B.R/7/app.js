...
var ds33 =  ['fndp-750-m-tl-el.php','fndp-1000-m-tl-el.php','fndp-1250-m-tl-el.php'];
...
for(var i = 0, b = 1; ds33.length > i; i++, b++) {
    ...
    '$modificationModal = $modification["mazutnye-gorelki-fndp-m-el"][' + i + '];' + // меняем серию
    '$modalPumpDesc = $modalPumpDesc_4_7_' + b + ';' + // меняем цифру
    '$modalPumpTable = $modalPumpTable_4_7_' + b + ';' + // меняем цифру
'?>' +
'<!-- main block start -->' + 
		'<main class="main">' +
				...
				'<div class="container">' +
					'<div class="bread-crumbs-content">' +
						'<ul class="bread-crumbs-list">' +
							...
							'</li>' +
							'<li class="bread-crumbs-item">' +
								'<a href="mazutnye-gorelki-fndp-m-el" class="bread-crumbs-link bread-crumbs-link-next bread-crumbs-link-spare-parts">F.B.R. FNDP /M EL</a>' + // меняем ссылку и название
							'</li>' +
							'<li class="bread-crumbs-item">' +
