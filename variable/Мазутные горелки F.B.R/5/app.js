...
var ds33 =  ['fndp-190-3-tl.php','fndp-250-3-tl.php','fndp-350-3-tl.php'];

for(var i = 0, b = 1; ds33.length > i; i++, b++) {
    fs.writeFile(ds33[i], '<?php' +
    ' require ' + '"variable/title-4.php";' +  
    '$title = "$producteTitle_5_' + b + '";' +  // меняем цифру
    '$description = "$producteDesc_5_' + b + '";' +  // меняем цифру
    'require "header.php";' +
    ...
    '$modificationModal = $modification["mazutnye-gorelki-fndp-3"][' + i + '];' + // меняем серию
    '$modalPumpDesc = $modalPumpDesc_4_5_' + b + ';' + // меняем цифру
    '$modalPumpTable = $modalPumpTable_4_5_' + b + ';' + // меняем цифру
'?>' +
'<!-- main block start -->' + 
		'<main class="main">' +
				...
				'<div class="container">' +
					'<div class="bread-crumbs-content">' +
						'<ul class="bread-crumbs-list">' +
							...
							'</li>' +
							'<li class="bread-crumbs-item">' +
								'<a href="mazutnye-gorelki-fndp-3" class="bread-crumbs-link bread-crumbs-link-next bread-crumbs-link-spare-parts">F.B.R. FNDP /3</a>' + // меняем ссылку и название
							'</li>' +
							'<li class="bread-crumbs-item">' +
