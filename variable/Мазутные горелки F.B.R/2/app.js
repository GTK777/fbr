...
var ds33 =  ['fndl-8-tc.php','fndl-8-tl.php','fndl-16-tc.php','fndl-16-tl.php','fndl-25-tc.php','fndl-25-tl.php'];
...
for(var i = 0, b = 1; ds33.length > i; i++, b++) {
    ...
    '$modificationModal = $modification["mazutnye-gorelki-fndl"][' + i + '];' + // меняем серию
    '$modalPumpDesc = $modalPumpDesc_4_2_' + b + ';' + // меняем цифру
    '$modalPumpTable = $modalPumpTable_4_2_' + b + ';' + // меняем цифру
'?>' +
'<!-- main block start -->' + 
		'<main class="main">' +
				...
				'<div class="container">' +
					'<div class="bread-crumbs-content">' +
						'<ul class="bread-crumbs-list">' +
							...
							'</li>' +
							'<li class="bread-crumbs-item">' +
								'<a href="mazutnye-gorelki-fndl" class="bread-crumbs-link bread-crumbs-link-next bread-crumbs-link-spare-parts">F.B.R. FNDL</a>' + // меняем ссылку и название
							'</li>' +
							'<li class="bread-crumbs-item">' +
				...
				'<div class="container">' +
					...
					'<div class="burners-modal-info__content">' +
						'<div class="burners-modal-info__content-left">' +
							'<img src="img/images/mazutnye-gorelki-fnl.png" alt="<?= $modificationModal["burnersModalName"] ?>">' +
						'</div>' +
