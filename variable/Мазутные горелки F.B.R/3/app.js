...
var ds33 =  ['fnp-25-2-tc.php','fnp-25-2-tl.php','fnp-45-2-tc.php','fnp-45-2-tl.php','fnp-70-2-tc.php','fnp-70-2-tl.php','fnp-100-2-tc.php','fnp-100-2-tl.php','fnp-125-2-tc.php','fnp-125-2-tl.php','fnp-150-2-tc.php','fnp-150-2-tl.php'];
...
for(var i = 0, b = 1; ds33.length > i; i++, b++) {
    ...
    '$modificationModal = $modification["mazutnye-gorelki-fnp-2"][' + i + '];' + // меняем серию
				...
				'<div class="container">' +
					'<div class="bread-crumbs-content">' +
						'<ul class="bread-crumbs-list">' +
							...
							'</li>' +
							'<li class="bread-crumbs-item">' +
								'<a href="mazutnye-gorelki-fnp-2" class="bread-crumbs-link bread-crumbs-link-next bread-crumbs-link-spare-parts">F.B.R. FNP /2</a>' + // меняем ссылку и название
							'</li>' +
							'<li class="bread-crumbs-item">' +
				...
				'<div class="container">' +
					...
					'<div class="burners-modal-info__content">' +
						'<div class="burners-modal-info__content-left">' +
							'<img src="img/images/mazutnye-gorelki-fnp-2.png" alt="<?= $modificationModal["burnersModalName"] ?>">' +
						'</div>' +
