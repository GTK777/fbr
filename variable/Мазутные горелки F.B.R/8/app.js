...
var ds33 =  ['mazutnye-promyshlennye-gorelki-serii-hi.php'];
...
for(var i = 0, b = 1; ds33.length > i; i++, b++) {
    ...
    '$modificationModal = $modification["mazutnye-gorelki-hi"][' + i + '];' + // меняем серию
    '$modalPumpDesc = $modalPumpDesc_4_8_' + b + ';' + // меняем цифру
    '$modalPumpTable = $modalPumpTable_4_8_' + b + ';' + // меняем цифру
'?>' +
'<!-- main block start -->' + 
		'<main class="main">' +
				...
				'<div class="container">' +
					'<div class="bread-crumbs-content">' +
						'<ul class="bread-crumbs-list">' +
							...
							'</li>' +
							'<li class="bread-crumbs-item">' +
								'<a href="mazutnye-gorelki-hi" class="bread-crumbs-link bread-crumbs-link-next bread-crumbs-link-spare-parts">F.B.R. HI</a>' + // меняем ссылку и название
							'</li>' +
							'<li class="bread-crumbs-item">' +
