...
var ds33 =  ['fndp-190-m-tl-mec.php','fndp-250-m-tl-mec.php','fndp-350-m-tl-mec.php','fndp-450-m-tl-mec.php','fndp-550-m-tl-mec.php','fndp-650-m-tl-mec.php'];

for(var i = 0, b = 8; ds33.length > i; i++, b++) {
    fs.writeFile(ds33[i], '<?php' +
    ' require ' + '"variable/title-4.php";' +  
    ...
    '$dataLinkAll = $dataLink["mazutnye-gorelki"];' +

    '$modification = require("variable/data-info-finish-3.php");' +
    '$dataDesc = require("variable/data-description.php");' +
    '$modificationModal = $modification["mazutnye-gorelki-fndp-m-2"][' + i + '];' + // меняем серию
    '$modalPumpDesc = $modalPumpDesc_4_6_' + b + ';' + // меняем цифру
    '$modalPumpTable = $modalPumpTable_4_6_' + b + ';' + // меняем цифру
'?>' +
'<!-- main block start -->' + 
		'<main class="main">' +
				...
				'<div class="container">' +
					'<div class="bread-crumbs-content">' +
						'<ul class="bread-crumbs-list">' +
							...
							'</li>' +
							'<li class="bread-crumbs-item">' +
								'<a href="mazutnye-gorelki" class="bread-crumbs-link bread-crumbs-link-next bread-crumbs-link-spare-parts">Мазутные горелки F.B.R.</a>' +
							'</li>' +
							'</li>' +
							'<li class="bread-crumbs-item">' +
								'<a href="mazutnye-gorelki-fndp-m" class="bread-crumbs-link bread-crumbs-link-next bread-crumbs-link-spare-parts">F.B.R. FNDP /M</a>' + // меняем ссылку и название
							'</li>' +
							'<li class="bread-crumbs-item">' +
