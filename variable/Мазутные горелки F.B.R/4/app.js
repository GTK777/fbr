...
var ds33 =  ['fndp-100-2-tc.php','fndp-100-2-tl.php','fndp-125-2-tc.php','fndp-125-2-tl.php','fndp-150-2-tc.php','fndp-150-2-tl.php'];

for(var i = 0, b = 7; ds33.length > i; i++, b++) {
    ...
    '$modificationModal = $modification["mazutnye-gorelki-fndp-2-2"][' + i + '];' + // меняем серию
    '$modalPumpDesc = $modalPumpDesc_4_4_' + b + ';' + // меняем цифру
    '$modalPumpTable = $modalPumpTable_4_4_' + b + ';' + // меняем цифру
'?>' +
'<!-- main block start -->' + 
		'<main class="main">' +
				...
				'<div class="container">' +
					'<div class="bread-crumbs-content">' +
						'<ul class="bread-crumbs-list">' +
							...
							'</li>' +
							'<li class="bread-crumbs-item">' +
								'<a href="mazutnye-gorelki-fndp-2" class="bread-crumbs-link bread-crumbs-link-next bread-crumbs-link-spare-parts">F.B.R. FNDP /2</a>' + // меняем ссылку и название
							'</li>' +
							'<li class="bread-crumbs-item">' +
